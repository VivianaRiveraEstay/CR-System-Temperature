...
P=[bmax(i) theta(j) m0 alpha gamma c Topt_x_0 mu epsilon(k) Tmax Gx amax phi h_opt p q0 delta beta sigma Topt_y_0 eta Gy];
%% Initial conditions:
...
for p2 = 1:length(epsilon)
    [~, h] = contourf(X, Y, R{1,p2}, contourLevels, 'LineStyle', 'none');
    view(3)
