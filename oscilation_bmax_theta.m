...
h_opt=0.25; % INITIAL HANDDLING TIME -- 0.3 Dee LE 2020
...
P=[bmax(i) theta(j) m0 alpha gamma c Topt_x_0 mu epsilon  Gx amax phi h_opt p q0 delta beta sigma Topt_y_0 eta Gy];
%% Initial conditions:
