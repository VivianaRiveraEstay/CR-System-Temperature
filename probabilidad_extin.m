% Parámetros
N = 10; % Asegúrate de definir N en algún lugar de tu código
...
P = [bmax, theta, m0, alpha, gamma, c, Topt_x_0, mu, epsilon, Gx, ...
     amax, phi, h_opt, p, q0, delta, beta, sigma, Topt_y_0, eta, Gy];
